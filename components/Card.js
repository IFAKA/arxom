...
const styles = {
    ...
    card: 'h-[250px] w-[190px] rounded-3xl flex cursos-pointer transition-all duration-300 hover:scale-105 hover:shadow-2xl overflow-hidden border border-black shadow-xl border-4 border-[#fb9701]',
